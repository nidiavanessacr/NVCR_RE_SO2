...
#### - Firewall: 
Sistema de seguridad de red que actúa como una barrera entre una red de confianza (como una red doméstica o de oficina) y una red externa no confiable (como Internet), filtrando y controlando el tráfico de red entrante y saliente.
#### - DNS
Sistema que traduce las direcciones web fáciles de recordar (como www.ejemplo.com) a las direcciones IP numéricas que las computadoras necesitan para comunicarse en Internet.
#### - VPN
Crea un "túnel" cifrado y seguro entre tu dispositivo e internet, ocultando tu dirección IP real y protegiendo tus datos personales del robo o la intercepción por parte de terceros.
#### - Proxys
Intermediario entre tu dispositivo e Internet que redirige tus solicitudes web, actuando como un representante para ocultar tu dirección IP real, proteger tu privacidad, eludir restricciones geográficas o mejorar la seguridad.
### Normas WIFI
